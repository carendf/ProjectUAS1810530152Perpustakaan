...
class TabelPinjamanController extends Controller
{
    ...
    {
        //
     //   $ambildata=TabelPinjaman::all();
      $ambildata = TabelPinjaman::with('data_buku')->get();
    ...
    public function store(Request $request)
    {
        ...
        $validasi = Validator::make($request->all(), [
            ...
            "kd_buku" => "required",
             ...
             if ($validasi->passes()) { 
                 $ambildata = TabelPinjaman::create($request->all()); 
                 return response()->json([ 
    ...
    {
        //
        $ambildata = TabelPinjaman::where('id', $id)->first(); 
        if (!empty($ambildata)) { 
            // return $data; 
            $validasi = Validator::make($request->all(), [ 
                "nama" => "required", 
